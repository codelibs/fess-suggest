...
public final class SuggestUtil {
    ...
    /**
     * Deletes the PIT (Point in Time) context associated with the given PIT ID.
     *
    ...
    public static void deletePitContext(final Client client, final String pitId) {
        if (pitId != null) {
            ...
            client.execute(DeletePitAction.INSTANCE, deletePitRequest, ActionListener.wrap(res -> {}, e -> {}));
        }
    }
