...
public class SpellCheckerTest extends TestCase {
    public void test_buildQuery() {
        ...
        assertEquals(readingField + ":リンゴとみかん~0.5 AND " + "(" + field + ":field1 OR " + field + ":field2) AND (" + labelField
                + ":label1 OR " + labelField + ":label2) AND (" + roleField + ":role1 OR " + roleField + ":role2)", query);
    }
}
