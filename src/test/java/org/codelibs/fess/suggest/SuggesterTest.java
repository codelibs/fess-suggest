...
public class SuggesterTest extends TestCase {
    public void test_buildQuery() {
        ...
        assertEquals("(" + readingField + ":リンゴとみかん* OR " + readingField + ":リンゴとミカン*) AND " + "(" + field + ":field1 OR " + field
                + ":field2) AND (" + labelField + ":label1 OR " + labelField + ":label2) AND (" + roleField + ":role1 OR " + roleField
                + ":role2)", query);
    }
    ...
    public void test_buildQueryWithSpace() {
        ...
        assertEquals(readingField + ":りんご* AND " + readingField + ":みかん*", query);
    }
