/*
 * Licensed to Fesen under one or more contributor
 * license agreements. See the NOTICE file distributed with
 * this work for additional information regarding copyright
 * ownership. Fesen licenses this file to you under
...
public class KuromojiTokenizerFactory extends AbstractTokenizerFactory {
    ...
    public static UserDictionary getUserDictionary(Environment env, Settings settings) {
        ...
        try {
            ...
            for (String line : ruleList) {
                ...
                if (line.startsWith("#") == false) {
                    ...
                    if (dup.add(values[0]) == false) {
                        throw new IllegalArgumentException("Found duplicate term [" + values[0]
                                + "] in user dictionary " + "at line [" + lineNum + "]");
                    }
                }
                ++lineNum;
            }
            ...
            throw new FesenException("failed to load kuromoji user dictionary", e);
        }
    }
